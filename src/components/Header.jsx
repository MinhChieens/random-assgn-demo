    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="block w-[12rem] xl:mr-8" href="#hero">
          <img src="./vite.svg" alt="Hospital" />
        </a>

        <nav className="flex fixed top-[5rem] left-0 right-0 bottom-0 bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent">
        ...
        <a
          className="mr-8 font-code uppercase text-n-1/50 transition-colors hover:text-n-1 lg:block"
          href="#login"
        >
          Log in
        </a>
