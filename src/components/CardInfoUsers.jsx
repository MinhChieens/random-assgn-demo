...
const CardInfoUsers = ({ typeUser, uid, handleDeleteUser, props }) => {
   ...
   return (
      <>
         {props ? (
            <div className="wrap flex flex-row items-center h-12 w-[95%] bg-transparent border-2 pr-3 rounded-lg font-[poppins] font-bold hover:bg-darkblue hover:text-white">
