...
const CardPatient = ({ props, uid }) => {
  ...
  return (
    <div className="w-[95%] mx-auto grid grid-cols-12 p-3 border-2 hover: items-center justify-items-center justify-center font-[poppins] font-bold hover:bg-darkblue hover:text-white ">
      <div className="head flex flex-row w-full col-span-2">
        <img
        ...
        <div className="info pl-3">
          ...
          <p className=" text-[#B5B5C3]">{"something"}</p>
        </div>
      </div>
      ...
      {btnAdd ? (
        <div className="pt-2">
          ...
          <div className="flex flex-col justify-center items-center gap-4 pt-4">
            {listPatients &&
              listPatients.map((p) => {
                return <CardPatient props={p.patient} uid={p.uid} />;
              })}
          </div>
        </div>
      ) : (
