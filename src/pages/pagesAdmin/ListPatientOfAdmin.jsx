...
const CardPatient = ({ props, uid, setUpload }) => {
  ...
  const tempInfor = {
    age: props.healthRecord.age,
    diagnose: props.healthRecord.diagnose,
    name: props.healthRecord.name,
    medicine: props.healthRecord.medicine,
    pathImage: props.information.pathImage,
    timeTreat: props.healthRecord.timeTreat,
