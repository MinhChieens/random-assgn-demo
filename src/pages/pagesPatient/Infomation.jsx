...
const Infomation = () => {
  ...
  return (
    <>
      <div className="wrap w-[95%] h-full mx-auto bg-yellow-200 grid grid-cols-3">
        <div className="image flex flex-col items-center  gap-5 col-span-1 bg-purple-200 ">
          <input
            name="ImagePath"
            type="file"
            accept="image/*"
        ...
        <div className="info col-span-2  bg-orange-200">
